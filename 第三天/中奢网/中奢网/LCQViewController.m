...
//            GDataXMLElement * rootElement = [addXML rootElement];
        ...
        [self.addImageView setImageWithURL:[NSURL URLWithString:addImage] placeholderImage:[UIImage imageNamed:@"photo"] options:SDWebImageLowPriority | SDWebImageRetryFailed];
        }
    }
}
#pragma mark - 滚动导航
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell.iconView setImageWithURL:[NSURL URLWithString: [[_tableData objectAtIndex:indexPath.row] surl]] placeholderImage:[UIImage imageNamed:@"photo"] options:SDWebImageRetryFailed | SDWebImageLowPriority];
