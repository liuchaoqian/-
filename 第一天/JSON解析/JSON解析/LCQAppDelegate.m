...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    NSData * data = [NSData dataWithContentsOfFile:@"/Users/qf/Desktop/初级网络/第一天/JSON解析/JSON解析/json.geojson"];
    
    NSMutableDictionary * mDict = [NSJSONSerialization JSONObjectWithData:data options:NSJSONReadingMutableContainers error:nil];
    
    NSMutableArray * programmers = [mDict objectForKey:@"programmers"];
    NSLog(@"%@", programmers);
